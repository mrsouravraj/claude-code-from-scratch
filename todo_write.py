#!/usr/bin/env python3
"""
todo_write.py: Implementation of Agentic Planning and State Tracking. Episode 03.
...
def main() -> None:
    ...
    """
    # UI Header
    print("\033[90mEpisode 03: plan before execute | todo_write + todo_update\033[0m\n")
    ...
    while True:
        try:
            # User Prompt in Cyan
            query: str = input("\033[36mEpisode 03 >> \033[0m").strip()
