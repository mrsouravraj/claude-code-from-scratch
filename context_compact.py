#!/usr/bin/env python3
"""
context_compact.py: Implementation of Automated 3-Layer Context Management Episode 06.
...
def main() -> None:
    """
    Initializes the terminal interaction for the Episode 06 'Context Compacting' agent.
    """
    ...
    # UI Header
    print(f"\033[90mEpisode 06: context compression at ~{COMPRESS_THRESHOLD//1000}k chars | memory → {MEMORY_FILE}\033[0m\n")

    # Main REPL loop
    while True:
        try:
            # User Input in Cyan
            query: str = input("\033[36me06 >> \033[0m").strip()
