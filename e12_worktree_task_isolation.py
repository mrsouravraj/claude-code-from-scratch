#!/usr/bin/env python3
"""
e12_worktree_task_isolation.py: Implementation of Git Worktree Task Isolation. Episode 12.
...
def main() -> None:
    ...
    # UI Header
    print(f"\033[90mEpisode 12: worktree isolation | {len(demo_tasks)} parallel tasks\033[0m\n")
