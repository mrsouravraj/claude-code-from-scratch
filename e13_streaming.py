#!/usr/bin/env python3
"""
e13_streaming.py: Implementation of Real-Time Token Streaming for AI Agents. Episode 13.
...
to a streaming architecture. In traditional requests (e01-e12), the user 
...
def main() -> None:
    ...
    """
    # UI Header in Gray
    print("\033[90mEpisode 13: streaming | tokens print as they arrive\033[0m\n")
    ...
    while True:
        try:
            # User Prompt in Cyan
            query: str = input("\033[36me13 >> \033[0m").strip()
