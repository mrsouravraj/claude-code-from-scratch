#!/usr/bin/env python3
"""
sub_agent.py: Implementation of Recursive Agent Delegation and Isolation. Episode 04.
...
def main() -> None:
    """
    Initializes the terminal interaction for the Episode 04 'Delegation' agent.
    """
    # Visual header in Gray (\033[90m)
    print("\033[90mEpisode 04: subagent isolation | spawn_subagent → fresh context\033[0m\n")
    ...
    while True:
        try:
            # Prompt user in Cyan
            query: str = input("\033[36me04 >> \033[0m").strip()
