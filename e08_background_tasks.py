#!/usr/bin/env python3
"""
e08_background_tasks.py: Implementation of Asynchronous Shell Command Execution. Episode 08.
...
def main() -> None:
    """
    Initializes the terminal interaction for the Episode 08 'Backgrounding' agent.
    """
    # Visual UI Header
    print("\033[90mEpisode 08: background tasks | bash_background → notified on completion\033[0m\n")
    ...
    while True:
        try:
            # User Input in Cyan
            query: str = input("\033[36me08 >> \033[0m").strip()
