#!/usr/bin/env python3
"""
skill_loading.py: Implementation of On-Demand Knowledge Retrieval. Episode 05.
...
def main() -> None:
    """
    Initializes the terminal interaction for the Episode 05 'Skill Loading' agent.
    """
    # Header display in Gray
    print("\033[90mEpisode 05: on-demand skill loading | list_skills · load_skill\033[0m\n")
    ...
    while True:
        try:
            # User Input in Cyan
            query: str = input("\033[36me05 >> \033[0m").strip()
