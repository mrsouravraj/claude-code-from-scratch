#!/usr/bin/env python3
"""
e14_tools_extended.py: Implementation of a Safety-First Extended Tool Arsenal. Episode 14.
...
commands, e14 promotes specialized tools (read, write, grep, glob) that 
...
def main() -> None:
    ...
    print(f"\033[90mEpisode 14: extended tools | {', '.join(active_tool_names)} | snapshots active\033[0m\n")
    ...
    while True:
        try:
            ...
            query: str = input("\033[36me14 >> \033[0m").strip()
